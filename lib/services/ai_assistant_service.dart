...
class AiAssistantService {
  static Future<List<AiAssistantModel>?> getAllAssistants({
    ...
    try {
      ...
      var request = http.Request('GET', Uri.parse('$kbAPIUrl/kb-core/v1/ai-assistant?q&order=DESC&order_field=createdAt&offset&limit=20&is_favorite&is_published'));
  ...
  static Future<AiAssistantModel?> createAssistant({
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        log('result of create chatbot ai: $result');
